...
HTTP `Content-Encoding` multiplexer — decoder (v0.1+) + one-shot encoder (v0.2+) + streaming encoder (v0.5 single-coding, v0.6 multi-coding) + streaming decoder (v0.7 single- and multi-coding; v0.8 inherits true memory-streaming for deflate/gzip/zlib chains; v0.9 uniform true memory-streaming for all coding chains including `br`). Sendable, Foundation-free.
...
### Streaming decode (v0.7+)

- ``ContentEncoding/Streaming/Decoder``
